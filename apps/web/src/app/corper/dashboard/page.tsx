...
export default function CorperDashboardPage() {
  const overview = useApiQuery<OverviewStats>("/common/dashboard-overview/");
    ...
    <DashboardShell role="corper" title="Corper overview" hideCorperBanner>
      <StatsGrid
        ...
        items={[
          ...
          { label: "Companies that have shown interest", value: overview.data?.received_interest_count ?? 0 },
          { label: "Companies you are interested in", value: overview.data?.sent_interest_count ?? 0 },
