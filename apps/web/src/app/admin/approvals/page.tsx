...
export default function AdminApprovalsPage() {
  ...
  return (
    <DashboardShell role="admin" title="Admin Approvals">
      <div className="grid gap-4">
        <p className="max-w-3xl text-sm leading-7 text-mist">
          Review and approve or reject pending admin access requests. Approved requests will be able to log into the admin dashboard.
        </p>

        <DataTable
          columns={["Email", "Requested", "Status", "Notified", "Reviewed by", "Action"]}
          rows={
