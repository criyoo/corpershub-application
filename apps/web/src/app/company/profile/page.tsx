...
function CompanyProfilePageContent() {
  ...
  function handleCompanyImageChange(event: ChangeEvent<HTMLInputElement>) {
    if (!canEditPhoto) {
      return;
    }
    ...
    setCompanyImagePreviewUrl(URL.createObjectURL(file));
  }
        ...
        <form onSubmit={handleSubmit}>
          <Card className="grid gap-6 bg-white/[0.01]">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <label className={GENERAL_LABEL}>
                <span>{fieldLabel("Sector", true)}</span>
                <Select
                  name="company_sector"
