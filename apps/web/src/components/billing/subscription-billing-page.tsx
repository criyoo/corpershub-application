    ...
    >
      ...
      >
        ...
        <p className="mt-3 text-sm leading-7 text-mist">
          ...
          <span className="text-white">{formatSubscriptionPlanLabel(prompt.currentPlanName)}</span>.Switching to a {" "} plan
          ...
          Your new plan will begin today once payment is confirmed.
        </p>
