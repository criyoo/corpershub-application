...
export const dashboardNav: Record<UserRole, NavItem[]> = {
  company: [
    ...
    { href: "/company/chat", label: "Corpers Chat", icon: ChatIcon },
  ...
  corper: [
    ...
    { href: "/corper/chat", label: "Company Chat", icon: ChatIcon },
    { href: "/corper/community", label: "Community Chat", icon: CommunityIcon },
