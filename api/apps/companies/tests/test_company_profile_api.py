...
class CompanyProfileAPITests(APITestCase):
    ...
    def company_image_file(self):
        image_bytes = BytesIO()
        Image.new("RGB", (900, 600), color=(24, 88, 64)).save(image_bytes, format="JPEG")
        image_bytes.seek(0)
    ...
    def test_company_can_upload_profile_image(self):
        ...
        self.assertTrue(self.company.company_image.name.endswith(".webp"))
        self.company.company_image.open("rb")
        with Image.open(self.company.company_image) as image:
