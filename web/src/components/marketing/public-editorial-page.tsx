...
export function PublicEditorialPage({
  ...
  backButtonFallbackHref = "/",
  backButtonLabel = "Back",
}: PublicEditorialPageProps) {
  return (
    <div className="overflow-hidden">
      <div className="mx-auto max-w-5xl px-0 py-2 md:px-2 md:py-4">
        <section className="mx-auto max-w-4xl">
          {showBackButton ? (
            <div className="mb-6">
              <BackButton fallbackHref={backButtonFallbackHref} label={backButtonLabel} />
            </div>
          ) : null}
