export type HostedPaymentGateway = "flutterwave";
...
export function getPreferredHostedPaymentGateway(): HostedPaymentGateway {
  return "flutterwave";
}

export function getHostedCheckoutProviderName(gateway: string | null | undefined) {
...
export function getHostedCheckoutRedirectMessage(gateway: string | null | undefined) {
