...
function ChatBubbleIcon(props: NavIconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="#C084FC" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" fill="#C084FC1D" />
    </svg>
  );
}

function BookOpenIcon(props: NavIconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="#F472B6" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M2 3h6a4 4 0 0 1 4 4V19a2 2 0 0 0 2 2H2" fill="#F472B61D" />
      <path d="M22 3h-6a4 4 0 0 0-4 4V19a2 2 0 0 1-2 2h10" />
    </svg>
  );
}
...
function CommunityIcon(props: NavIconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="#A78BFA" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M4 21V7l4-4h8l4 4v14" fill="#A78BFA14" />
      <path d="M9 10h6" />
      <path d="M9 14h6" />
    </svg>
  );
...
export const dashboardNav: Record<UserRole, NavItem[]> = {
  company: [
    ...
    { href: "/company/how-it-works", label: "How It Works", icon: SupportIcon },
    ...
    { href: "/company/chat", label: "Chat with Corpers", icon: ChatIcon },
  ...
  corper: [
    ...
    { href: "/about", label: "About", icon: SupportIcon },
    { href: "/corper/how-it-works", label: "How It Works", icon: SupportIcon },
    { href: "/corper/profile", label: "Profile", icon: ProfileIcon },
    { href: "/sectors", label: "Participating Sectors", icon: CompaniesIcon },
    ...
    { href: "/corper/chat", label: "Chat with Companies", icon: ChatIcon },
    { href: "/corper/community", label: "Corpers Chat Room", icon: CommunityIcon },
